    ...
    return Controller.extend("zfioritest0001.controller.BaseController", {
        ...
        onValueHelpClose: function (oEvent) {
            ...
            if (selectedItem) {
                ...
                if (Value) {
                    this.__oButton.setValue(Value);
                    //--form里面的带出描述,表中不带出描述
                    if (this.__oButton.getParent() && this.__oButton.getParent().sParentAggregationName == "rows") {
                    } else {
                        this.__oButton.setDescription(description);
                    }
                } else {
        ...
        onSuggestionItemSelected: function (oEvent) {
            ...
            //--form里面的带出描述,表中不带出描述
            if (oEvent.getSource().getParent() && oEvent.getSource().getParent().sParentAggregationName == "rows") {
            } else {
