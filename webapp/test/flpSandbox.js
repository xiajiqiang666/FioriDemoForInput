		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#valueHelpDialog-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"valueHelpDialog-display": {
								"semanticObject": "valueHelpDialog",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zfioritest0001",
									"url": sap.ui.require.toUrl("zfioritest0001")
								}
							}
						}
					}
